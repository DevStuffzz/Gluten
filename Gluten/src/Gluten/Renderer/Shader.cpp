...
namespace Gluten::Renderer {
	...
	Shader::Shader(const std::string& vertexSrc, const std::string& fragmentSrc)
	{
		...
		if (isCompiled == GL_FALSE)
		{
			...
			GLUT_CORE_ERROR("{0}", infoLog.data());
			GLUT_CORE_ASSERT(false, "Vertex shader compilation failure!");
			return;
		}
		...
		if (isCompiled == GL_FALSE)
		{
			...
			GLUT_CORE_ERROR("{0}", infoLog.data());
			GLUT_CORE_ASSERT(false, "Fragment shader compilation failure!");
			return;
		}
		...
		if (isLinked == GL_FALSE)
		{
			...
			GLUT_CORE_ERROR("{0}", infoLog.data());
			GLUT_CORE_ASSERT(false, "Shader link failure!");
			return;
		}
